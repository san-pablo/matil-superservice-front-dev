...
return(<>
    ...
    <Box> 
        ...
        <Flex flexDir={'row-reverse'}> 
            <Button variant={'common'} onClick={sendNewTicketData} isDisabled={JSON.stringify(ticketsData) === JSON.stringify(ticketDataRef.current)}>{waitingSend?<LoadingIconButton/>:'Guardar cambios'}</Button>
        </Flex>
    </Box>
    </>)
}

...
const InstagramButton = () => {
  ...
  return (<>
    <Button onClick={handleAuth} size='md' w='100%' leftIcon={<FaInstagram/>} bg={'linear-gradient(to right, #833ab4,#fd1d1d,#fcb045)'} _hover={{bg:'linear-gradient(to right, #833ab4,#fd1d1d,#fcb045)'}} opacity={0.8} color='#fff'>

    ...
    return (
        <Flex alignItems={'center'} gap='15px'  mt='1vh'>
            <Flex gap='5px' fontSize={'.9em'}>
                {keys.map((key, index) => (<> 
                    <Flex key={`key-${index}-${description}`} px='5px' borderRadius={'.2rem'} bg='gray_1' borderColor={'border_color'} justifyContent={'center'} alignItems={'center'} borderWidth={'1px'}>
        ...
        <Box flex='1'  p='0 20px 50px 20px' overflowY={'scroll'}> 
          <Flex gap='50px'> 
            <Box>
              ...
              <Text fontSize={'.9em'} color='text_gray'>{t('navigation.description')}</Text>        
              ...
              <Text fontWeight={'medium'} fontSize={'.9em'} mt='3vh' color='text_gray'>{t('navigation.lists.description')}</Text>      
            ...
            <Box>
              ...
              <Text  fontSize={'.9em'} color='text_gray'>{t('conversations.description')}</Text>        
              ...
              <Text  fontSize={'.9em'} mt='3vh' color='text_gray'>{t('conversations.saveUpdate.description')}</Text>        
              ...
              <Text  fontSize={'.9em'} mt='3vh' color='text_gray'>{t('conversations.writing.description')}</Text>      
